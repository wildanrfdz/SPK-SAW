                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $hasil['level'] ?></td>
                                        <td><a onclick="ubah('<?= $hasil['id_login'] ?>')" class="btn btn-primary btn-sm">Edit</a> | <a onclick="return confirm('Apakah kamu yakin akan menghapus?')" href="posts/user-proses.php?tipe=hapus&kode=<?= $hasil['id_login'] ?>" class="btn btn-danger btn-sm">Hapus</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
