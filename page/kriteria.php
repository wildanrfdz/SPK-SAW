    ...
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a onclick="tambah()" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $hasil['kode_kriteria'] ?></td>
                                        <td><?= $hasil['nama_kriteria'] ?></td>
                                        <td><?= $hasil['nilai_input'] ?> %</td>
                                        <td><?= $hasil['nilai'] ?></td>
                                        <td><?= $hasil['atribut'] ?></td>
                                        <td><a onclick="ubah('<?= $hasil['kode_kriteria'] ?>')" class="btn btn-primary btn-sm">Edit</a> | <a onclick="return confirm('Apakah kamu yakin akan menghapus?')" href="posts/kriteria-proses.php?tipe=hapus&kode=<?= $hasil['kode_kriteria'] ?>" class="btn btn-danger btn-sm">Hapus</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
